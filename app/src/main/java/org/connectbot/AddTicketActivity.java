...
public class AddTicketActivity extends AppCompatActivity {
	...
	public final static String TAG = "CB.AddTicketAct";
	...
	public void onCreate(Bundle icicle) {
		...
		save.setOnClickListener(new OnClickListener() {
			public void onClick(View view) {
				AddTicketActivity.this.save.setEnabled(false);

				AddTicketActivity.this.startEntropyGather();
			}
		});
	...
	private void startKeyGen() {
		progress = new ProgressDialog(AddTicketActivity.this);
		progress.setMessage(AddTicketActivity.this.getResources().getText(R.string.pubkey_generating));
	...
	public void onGenerationSuccess(KeyPair pair) {
		try {
			...
			PubkeyDatabase pubkeydb = PubkeyDatabase.get(AddTicketActivity.this);
